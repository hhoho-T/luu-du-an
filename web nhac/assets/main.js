...
const app = {
    ...
    songs: [{
            ...
            singer: 'MTP',
            path: './music/ChacAiDoSeVe.mp3',
            image: './img/chac-ai-do-se-ve-1.jpg',
        },
        {
            name: 'Em Của Ngày Hôm Qua',
            singer: 'MTP',
            path: './music/EmCuaNgayHomQuaTheRemix-SonTungMTP-3764277.mp3',
            image: './img/220px-Em_của_ngày_hôm_qua.png',
        },
        {
            name: 'Em Của Quá Khứ',
            singer: 'Nguyen Dinh Vu',
            path: './music/EmCuaQuaKhu-NguyenDinhVu-3803580.mp3',
            image: './img/emcuaquakhu.jpg',
        },
        {
            name: 'Đường Tôi Trở em Về',
            singer: 'Lofi ver',
            path: './music/TaiNhacHay.Biz - Đường Tôi Chở Em Về.mp3',
            image: './img/duongemtrove.jpg',
        },
        // nào rảnh thì thêm nhạc vào
